...
if __name__ == '__main__':
    ...
    # 本番用
    password = 'FpF5 mBjo 5Tm6 S9br mebe vtTw'
    end_point_url = 'https://crich-media.com/keio/wp-json/wp/v2/subject/'

    surveies = []
    with open('classified/classified_survey.csv') as f:
        reader = csv.reader(f)
    ...
    for survey in surveies:
        ...
        if res.status_code == 201:
            ...
            acf_end_point_url = f'https://crich-media.com/keio/wp-json/acf/v3/subject/{post_id}'
